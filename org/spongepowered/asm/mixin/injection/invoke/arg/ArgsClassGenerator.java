...
public final class ArgsClassGenerator implements IClassGenerator
{
    ...
    private final BiMap classNames;
    private final Map classBytes;
    
    public ArgsClassGenerator() {
        this.nextIndex = 1;
        this.classNames = (BiMap)HashBiMap.create();
        this.classBytes = new HashMap();
    }
    
    public String getClassName(final String s) {
        final String changeDescriptorReturnType = Bytecode.changeDescriptorReturnType(s, "V");
        String format = (String)this.classNames.get((Object)changeDescriptorReturnType);
        if (format == null) {
            format = String.format("%s%d", "org.spongepowered.asm.synthetic.args.Args$", this.nextIndex++);
            this.classNames.put((Object)changeDescriptorReturnType, (Object)format);
        }
        return format;
    }
    ...
    private byte[] generateClass(final String s, final String s2) {
        ...
        Object o;
        final ClassWriter classWriter = (ClassWriter)(o = new ClassWriter(2));
        if (MixinEnvironment.getCurrentEnvironment().getOption(MixinEnvironment.Option.DEBUG_VERIFY)) {
            o = new CheckClassAdapter((ClassVisitor)classWriter);
        }
        ((ClassVisitor)o).visit(50, 4129, replace, (String)null, ArgsClassGenerator.ARGS_REF, (String[])null);
        ((ClassVisitor)o).visitSource(s.substring(s.lastIndexOf(46) + 1) + ".java", (String)null);
        this.generateCtor(replace, s2, argumentTypes, (ClassVisitor)o);
        this.generateToString(replace, s2, argumentTypes, (ClassVisitor)o);
        this.generateFactory(replace, s2, argumentTypes, (ClassVisitor)o);
        this.generateSetters(replace, s2, argumentTypes, (ClassVisitor)o);
        this.generateGetters(replace, s2, argumentTypes, (ClassVisitor)o);
        ((ClassVisitor)o).visitEnd();
        return classWriter.toByteArray();
    }
    
    private void generateCtor(final String s, final String s2, final Type[] array, final ClassVisitor classVisitor) {
        final MethodVisitor visitMethod = classVisitor.visitMethod(2, "<init>", "([Ljava/lang/Object;)V", (String)null, (String[])null);
    ...
    private void generateToString(final String s, final String s2, final Type[] array, final ClassVisitor classVisitor) {
        final MethodVisitor visitMethod = classVisitor.visitMethod(1, "toString", "()Ljava/lang/String;", (String)null, (String[])null);
        visitMethod.visitCode();
        visitMethod.visitLdcInsn((Object)("Args" + getSignature(array)));
    ...
    private void generateFactory(final String s, final String s2, final Type[] array, final ClassVisitor classVisitor) {
        final MethodVisitorEx methodVisitorEx = new MethodVisitorEx(classVisitor.visitMethod(9, "of", Bytecode.changeDescriptorReturnType(s2, "L" + s + ";"), (String)null, (String[])null));
        ...
        for (final Type type : array) {
            ...
            methodVisitorEx.visitVarInsn(type.getOpcode(21), (int)b);
    ...
    private void generateGetters(final String s, final String s2, final Type[] array, final ClassVisitor classVisitor) {
        byte b = 0;
        for (final Type type : array) {
            final MethodVisitorEx methodVisitorEx = new MethodVisitorEx(classVisitor.visitMethod(1, "$" + b, "()" + type.getDescriptor(), (String)null, (String[])null));
            methodVisitorEx.visitCode();
    ...
    private void generateIndexedSetter(final String s, final String s2, final Type[] array, final ClassVisitor classVisitor) {
        final MethodVisitorEx methodVisitorEx = new MethodVisitorEx(classVisitor.visitMethod(1, "set", "(ILjava/lang/Object;)V", (String)null, (String[])null));
        methodVisitorEx.visitCode();
    ...
    private void generateMultiSetter(final String s, final String s2, final Type[] array, final ClassVisitor classVisitor) {
        final MethodVisitorEx methodVisitorEx = new MethodVisitorEx(classVisitor.visitMethod(1, "setAll", "([Ljava/lang/Object;)V", (String)null, (String[])null));
        methodVisitorEx.visitCode();
        final Label label = new Label();
        final Label label2 = new Label();
        int n = 6;
        ...
        methodVisitorEx.visitConstant((byte)array.length);
        methodVisitorEx.visitLdcInsn((Object)getSignature(array));
    ...
    private static void throwNPE(final MethodVisitorEx methodVisitorEx, final String s) {
        ...
        methodVisitorEx.visitInsn(89);
        methodVisitorEx.visitLdcInsn((Object)s);
