...
public class CallbackInjectionInfo extends InjectionInfo
{
    ...
    protected Injector parseInjector(final AnnotationNode annotationNode) {
        return (Injector)new CallbackInjector((InjectionInfo)this, (boolean)Annotations.getValue(annotationNode, "cancellable", Boolean.FALSE), (LocalCapture)Annotations.getValue(annotationNode, "locals", LocalCapture.class, (Enum)LocalCapture.NO_CAPTURE), (String)Annotations.getValue(annotationNode, "id", ""));
    }
