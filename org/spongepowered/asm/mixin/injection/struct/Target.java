...
public class Target implements Comparable, Iterable
{
    ...
    public MethodInsnNode findInitNodeFor(final TypeInsnNode typeInsnNode) {
        final ListIterator iterator = this.insns.iterator(this.indexOf((AbstractInsnNode)typeInsnNode));
    ...
    private void addLocalVariable(final int n, final String s, final String s2, final LabelNode labelNode, final LabelNode labelNode2) {
        ...
        this.method.localVariables.add(new LocalVariableNode(s, s2, (String)null, labelNode, labelNode2, n));
    }
