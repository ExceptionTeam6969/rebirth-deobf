...
public class InjectionPointData
{
    ...
    public InjectionPointData(final IMixinContext context, final MethodNode method, final AnnotationNode parent, final String at, final List list, final String target, final String s, final int n, final int opcode, final String id) {
    ...
    private void parseArgs(final List list) {
        if (list == null) {
            return;
        }
