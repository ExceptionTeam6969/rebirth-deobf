...
public class BeforeConstant extends InjectionPoint
{
    ...
    public BeforeConstant(final IMixinContext mixinContext, final AnnotationNode annotationNode, final String s) {
        ...
        final Boolean b = (Boolean)Annotations.getValue(annotationNode, "nullValue", (Object)null);
        this.ordinal = (int)Annotations.getValue(annotationNode, "ordinal", -1);
        this.nullValue = (b != null && b);
        this.intValue = (Integer)Annotations.getValue(annotationNode, "intValue", (Object)null);
        this.floatValue = (Float)Annotations.getValue(annotationNode, "floatValue", (Object)null);
        this.longValue = (Long)Annotations.getValue(annotationNode, "longValue", (Object)null);
        this.doubleValue = (Double)Annotations.getValue(annotationNode, "doubleValue", (Object)null);
        this.stringValue = (String)Annotations.getValue(annotationNode, "stringValue", (Object)null);
        this.typeValue = (Type)Annotations.getValue(annotationNode, "classValue", (Object)null);
        ...
        this.log = (boolean)Annotations.getValue(annotationNode, "log", Boolean.FALSE);
    }
    ...
    private int[] parseExpandOpcodes(final List list) {
    ...
    public boolean find(final String s, final InsnList list, final Collection collection) {
        ...
        final ListIterator iterator = list.iterator();
        int n = 0;
        int opcode = 0;
        while (iterator.hasNext()) {
