...
public final class MethodSlice
{
    ...
    public static MethodSlice parse(final ISliceContext sliceContext, final Slice slice) {
        ...
        return new MethodSlice(sliceContext, id, (from != null) ? InjectionPoint.parse((IInjectionPointContext)sliceContext, from) : null, (to != null) ? InjectionPoint.parse((IInjectionPointContext)sliceContext, to) : null);
    }
    
    public static MethodSlice parse(final ISliceContext sliceContext, final AnnotationNode annotationNode) {
        final String s = (String)Annotations.getValue(annotationNode, "id");
        final AnnotationNode annotationNode2 = (AnnotationNode)Annotations.getValue(annotationNode, "from");
        final AnnotationNode annotationNode3 = (AnnotationNode)Annotations.getValue(annotationNode, "to");
        return new MethodSlice(sliceContext, s, (annotationNode2 != null) ? InjectionPoint.parse((IInjectionPointContext)sliceContext, annotationNode2) : null, (annotationNode3 != null) ? InjectionPoint.parse((IInjectionPointContext)sliceContext, annotationNode3) : null);
    }
    ...
    static final class InsnListSlice extends ReadOnlyInsnList
    {
        ...
        static class SliceIterator implements ListIterator
        {
            ...
            public SliceIterator(final ListIterator iter, final int start, final int end, final int index) {
                this.iter = iter;
                this.start = start;
                this.end = end;
                this.index = index;
