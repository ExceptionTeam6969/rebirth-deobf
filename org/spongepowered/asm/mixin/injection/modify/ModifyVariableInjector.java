...
public class ModifyVariableInjector extends Injector
{
    ...
    private void inject(final Context context, final int n) {
        ...
        context.insns.add((AbstractInsnNode)new VarInsnNode(this.returnType.getOpcode(21), n));
        this.invokeHandler(context.insns);
        context.insns.add((AbstractInsnNode)new VarInsnNode(this.returnType.getOpcode(54), n));
    }
    ...
    abstract static class ContextualInjectionPoint extends InjectionPoint
    {
        ...
        abstract boolean find(final Target p0, final Collection p1);
    }
