...
public class BeforeLoadLocal extends ModifyVariableInjector.ContextualInjectionPoint
{
    ...
    @Override
    boolean find(final Target target, final Collection collection) {
    ...
    static class SearchState
    {
        ...
        void check(final Collection collection, final AbstractInsnNode abstractInsnNode, final int n) {
            this.pendingCheck = false;
