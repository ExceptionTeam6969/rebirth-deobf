...
public class MixinServiceLaunchWrapper implements IMixinService, IClassProvider, IClassBytecodeProvider
{
    ...
    public Collection getPlatformAgents() {
        return (Collection)ImmutableList.of((Object)"org.spongepowered.asm.launch.platform.MixinPlatformAgentFML");
    }
    ...
    public byte[] getClassBytes(final String s, final String s2) throws IOException {
        ...
        try {
            ...
            final byte[] byteArray = IOUtils.toByteArray(resourceAsStream);
