...
public class BasicVerifier extends BasicInterpreter
{
    ...
    public BasicValue copyOperation(final AbstractInsnNode abstractInsnNode, final BasicValue basicValue) throws AnalyzerException {
        ...
        switch (abstractInsnNode.getOpcode()) {
            ...
            case 58: {
                if (!basicValue.isReference() && !BasicValue.RETURNADDRESS_VALUE.equals((Object)basicValue)) {
                    throw new AnalyzerException(abstractInsnNode, (String)null, (Object)"an object reference or a return address", (Value)basicValue);
                }
                return basicValue;
            }
            default: {
    ...
    public BasicValue ternaryOperation(final AbstractInsnNode abstractInsnNode, final BasicValue basicValue, final BasicValue basicValue2, final BasicValue basicValue3) throws AnalyzerException {
        ...
        if (!this.isSubTypeOf(basicValue, basicValue4)) {
            throw new AnalyzerException(abstractInsnNode, "First argument", (Object)("a " + basicValue4 + " array reference"), (Value)basicValue);
        }
        ...
        if (!this.isSubTypeOf(basicValue3, basicValue5)) {
            throw new AnalyzerException(abstractInsnNode, "Third argument", (Object)basicValue5, (Value)basicValue3);
        }
        return null;
    }
    
    public BasicValue naryOperation(final AbstractInsnNode abstractInsnNode, final List list) throws AnalyzerException {
        ...
        if (opcode == 197) {
            ...
            while (j < list.size()) {
                ...
                final BasicValue basicValue = list.get(j++);
                if (!this.isSubTypeOf(basicValue, value)) {
                    throw new AnalyzerException(abstractInsnNode, "Argument " + n, (Object)value, (Value)basicValue);
                }
            }
        }
    ...
    public Value naryOperation(final AbstractInsnNode abstractInsnNode, final List list) throws AnalyzerException {
        return (Value)this.naryOperation(abstractInsnNode, list);
    }
    ...
    public Value ternaryOperation(final AbstractInsnNode abstractInsnNode, final Value value, final Value value2, final Value value3) throws AnalyzerException {
        return (Value)this.ternaryOperation(abstractInsnNode, (BasicValue)value, (BasicValue)value2, (BasicValue)value3);
    }
