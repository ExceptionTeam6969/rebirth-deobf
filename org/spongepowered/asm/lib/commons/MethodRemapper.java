...
public class MethodRemapper extends MethodVisitor
{
    ...
    public AnnotationVisitor visitAnnotationDefault() {
        ...
        return (AnnotationVisitor)((visitAnnotationDefault == null) ? visitAnnotationDefault : new AnnotationRemapper(visitAnnotationDefault, this.remapper));
    }
    
    @Override
    public AnnotationVisitor visitAnnotation(final String s, final boolean b) {
        final AnnotationVisitor visitAnnotation = super.visitAnnotation(this.remapper.mapDesc(s), b);
        return (AnnotationVisitor)((visitAnnotation == null) ? visitAnnotation : new AnnotationRemapper(visitAnnotation, this.remapper));
    }
    ...
    public AnnotationVisitor visitTypeAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        ...
        return (AnnotationVisitor)((visitTypeAnnotation == null) ? visitTypeAnnotation : new AnnotationRemapper(visitTypeAnnotation, this.remapper));
    }
    ...
    public AnnotationVisitor visitParameterAnnotation(final int n, final String s, final boolean b) {
        ...
        return (AnnotationVisitor)((visitParameterAnnotation == null) ? visitParameterAnnotation : new AnnotationRemapper(visitParameterAnnotation, this.remapper));
    }
    ...
    public AnnotationVisitor visitInsnAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        ...
        return (AnnotationVisitor)((visitInsnAnnotation == null) ? visitInsnAnnotation : new AnnotationRemapper(visitInsnAnnotation, this.remapper));
    }
    ...
    public AnnotationVisitor visitTryCatchAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        ...
        return (AnnotationVisitor)((visitTryCatchAnnotation == null) ? visitTryCatchAnnotation : new AnnotationRemapper(visitTryCatchAnnotation, this.remapper));
    }
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(final int n, final TypePath typePath, final Label[] array, final Label[] array2, final int[] array3, final String s, final boolean b) {
        ...
        return (AnnotationVisitor)((visitLocalVariableAnnotation == null) ? visitLocalVariableAnnotation : new AnnotationRemapper(visitLocalVariableAnnotation, this.remapper));
    }
}
