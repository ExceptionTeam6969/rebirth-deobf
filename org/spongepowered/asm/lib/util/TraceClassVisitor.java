...
public final class TraceClassVisitor extends ClassVisitor
{
    ...
    public TraceClassVisitor(final ClassVisitor classVisitor, final PrintWriter printWriter) {
        this(classVisitor, (Printer)new Textifier(), printWriter);
    }
    ...
    public AnnotationVisitor visitAnnotation(final String s, final boolean b) {
        return (AnnotationVisitor)new TraceAnnotationVisitor((this.cv == null) ? null : this.cv.visitAnnotation(s, b), this.p.visitClassAnnotation(s, b));
    }
    
    public AnnotationVisitor visitTypeAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        return (AnnotationVisitor)new TraceAnnotationVisitor((this.cv == null) ? null : this.cv.visitTypeAnnotation(n, typePath, s, b), this.p.visitClassTypeAnnotation(n, typePath, s, b));
    }
