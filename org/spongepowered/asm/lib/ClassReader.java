...
public class ClassReader
{
    ...
    private void copyBootstrapMethods(final ClassWriter classWriter, final Item[] array, final char[] array2) {
        ...
        while (j < unsignedShort) {
            ...
            item.set(n2, hashCode & Integer.MAX_VALUE);
    ...
    private static byte[] readClass(final InputStream inputStream, final boolean b) throws IOException {
        ...
        while (true) {
            ...
            final byte[] array5 = new byte[array.length + 1000];
    ...
    private int readField(final ClassVisitor classVisitor, final Context context, int n) {
        ...
        for (int i = this.readUnsignedShort(n); i > 0; --i) {
            ...
            if ("ConstantValue".equals(utf11)) {
                ...
                o = ((unsignedShort2 == 0) ? null : this.readConst(unsignedShort2, buffer));
            }
    ...
    private int readAnnotationValue(int n, final char[] array, final String s, final AnnotationVisitor annotationVisitor) {
        if (annotationVisitor != null) {
            Label_1209: {
                switch (this.b[n++] & 0xFF) {
                    ...
                    case 66: {
                        annotationVisitor.visit(s, (Object)(byte)this.readInt(this.items[this.readUnsignedShort(n)]));
                        n += 2;
                        break;
                    }
                    case 90: {
                        annotationVisitor.visit(s, (Object)((this.readInt(this.items[this.readUnsignedShort(n)]) == 0) ? Boolean.FALSE : Boolean.TRUE));
                        n += 2;
                        break;
                    }
                    case 83: {
                        annotationVisitor.visit(s, (Object)(short)this.readInt(this.items[this.readUnsignedShort(n)]));
                        n += 2;
                        break;
                    }
                    case 67: {
                        annotationVisitor.visit(s, (Object)(char)this.readInt(this.items[this.readUnsignedShort(n)]));
                        n += 2;
                        break;
                    }
                    case 115: {
                        annotationVisitor.visit(s, (Object)this.readUTF8(n, array));
                        n += 2;
                        break;
                    }
                    case 101: {
                    ...
                    case 99: {
                        annotationVisitor.visit(s, (Object)Type.getType(this.readUTF8(n, array)));
                        n += 2;
                        break;
                    }
                    case 64: {
                    ...
                    case 91: {
                        ...
                        switch (this.b[n++] & 0xFF) {
                            case 66: {
                                ...
                                annotationVisitor.visit(s, (Object)array2);
                                --n;
                                break Label_1209;
                            }
                            case 90: {
                                ...
                                annotationVisitor.visit(s, (Object)array3);
                                --n;
                                break Label_1209;
                            }
                            case 83: {
                                ...
                                annotationVisitor.visit(s, (Object)array4);
                                --n;
                                break Label_1209;
                            }
                            case 67: {
                                ...
                                for (int l = 0; l < unsignedShort; ++l) {
                                    array5[l] = (char)this.readInt(this.items[this.readUnsignedShort(n)]);
                                    n += 3;
                                }
                                annotationVisitor.visit(s, (Object)array5);
                                --n;
                                break Label_1209;
                            }
                            case 73: {
                                ...
                                for (int n2 = 0; n2 < unsignedShort; ++n2) {
                                    array6[n2] = this.readInt(this.items[this.readUnsignedShort(n)]);
                                    n += 3;
                                }
                                annotationVisitor.visit(s, (Object)array6);
                                --n;
                                break Label_1209;
                            }
                            case 74: {
                                ...
                                for (int n3 = 0; n3 < unsignedShort; ++n3) {
                                    array7[n3] = this.readLong(this.items[this.readUnsignedShort(n)]);
                                    n += 3;
                                }
                                annotationVisitor.visit(s, (Object)array7);
                                --n;
                                break Label_1209;
                            }
                            case 70: {
                                ...
                                for (int n4 = 0; n4 < unsignedShort; ++n4) {
                                    array8[n4] = Float.intBitsToFloat(this.readInt(this.items[this.readUnsignedShort(n)]));
                                    n += 3;
                                }
                                annotationVisitor.visit(s, (Object)array8);
                                --n;
                                break Label_1209;
                            }
                            case 68: {
                                ...
                                for (int n5 = 0; n5 < unsignedShort; ++n5) {
                                    array9[n5] = Double.longBitsToDouble(this.readLong(this.items[this.readUnsignedShort(n)]));
                                    n += 3;
                                }
                                annotationVisitor.visit(s, (Object)array9);
                                --n;
                                break Label_1209;
                            }
                            default: {
    ...
    private Attribute readAttribute(final Attribute[] array, final String s, final int n, final int n2, final char[] array2, final int n3, final Label[] array3) {
        ...
        return new Attribute(s).read(this, n, n2, (char[])null, -1, (Label[])null);
    }
