...
public class MixinPlatformManager
{
    ...
    public Collection getPhaseProviderClasses() {
        final Collection phaseProviders = this.primaryContainer.getPhaseProviders();
        if (phaseProviders != null) {
            return Collections.unmodifiableCollection((Collection<?>)phaseProviders);
        }
    ...
    public final void prepare(final List list) {
        this.prepared = true;
