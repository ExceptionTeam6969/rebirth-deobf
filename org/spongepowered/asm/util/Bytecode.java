...
public final class Bytecode
{
    ...
    public static void textify(final ClassNode classNode, final OutputStream outputStream) {
        classNode.accept((ClassVisitor)new TraceClassVisitor(new PrintWriter(outputStream)));
    }
        ...
        if (n >= n2) {
            ...
            try {
                for (final Field field : Opcodes.class.getDeclaredFields()) {
                    if (n3 != 0 || field.getName().equals(s)) {
                        n3 = 1;
    ...
    public static void loadArgs(final Type[] array, final InsnList list, final int n, final int n2, final Type[] array2) {
        ...
        for (final Type type : array) {
            list.add((AbstractInsnNode)new VarInsnNode(type.getOpcode(21), n3));
            if (array2 != null && n4 < array2.length && array2[n4] != null) {
                list.add((AbstractInsnNode)new TypeInsnNode(192, array2[n4].getInternalName()));
            }
            n3 += type.getSize();
            if (n2 >= n && n3 >= n2) {
                return;
    ...
    public static Map cloneLabels(final InsnList list) {
    ...
    public static boolean compareFlags(final MethodNode methodNode, final MethodNode methodNode2, final int n) {
        hasFlag(methodNode, n);
        return methodNode2 == n;
    }
    ...
    private static List mergeAnnotations(final List list, List list2, final String s, final String s2) {
        try {
            if (list == null) {
                return list2;
            }
    ...
    public enum Visibility
    {
        ...
        private Visibility(final String s, final int n, final int access) {
            this.access = access;
        }
