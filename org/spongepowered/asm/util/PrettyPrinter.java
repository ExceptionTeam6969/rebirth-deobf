...
public class PrettyPrinter
{
    ...
    public PrettyPrinter addWrapped(final int n, final String s, final Object... array) {
        ...
        try {
            final Iterator iterator = this.getWrapped(n, replace, group).iterator();
            while (iterator.hasNext()) {
    ...
    private List getWrapped(final int n, String string, final String s) {
    ...
    static class Table implements IVariableWidthEntry
    {
        ...
        public String toString() {
            ...
            for (int i = 0; i < this.columns.size(); ++i) {
                array[i] = ((Column)this.columns.get(i)).toString();
                b |= !array[i].isEmpty();
            }
    ...
    public enum Alignment
    {
        ...
        private Alignment(final String s, final int n) {
        }
