...
abstract class AnnotatedMixinElementHandler
{
    ...
    protected final void addFieldMappings(final String s, final String s2, final ObfuscationData obfuscationData) {
        for (final ObfuscationType obfuscationType : obfuscationData) {
            final MappingField mappingField = (MappingField)obfuscationData.get(obfuscationType);
    ...
    protected final void addMethodMappings(final String s, final String s2, final ObfuscationData obfuscationData) {
        for (final ObfuscationType obfuscationType : obfuscationData) {
            final MappingMethod mappingMethod = (MappingMethod)obfuscationData.get(obfuscationType);
    ...
    protected final void checkConstraints(final ExecutableElement executableElement, final AnnotationHandle annotationHandle) {
        try {
            final ConstraintParser.Constraint parse = ConstraintParser.parse((String)annotationHandle.getValue("constraints"));
            try {
    ...
    protected final void validateTargetField(final VariableElement variableElement, final AnnotationHandle annotationHandle, final AliasedElementName aliasedElementName, final String s) {
        ...
        for (final TypeHandle typeHandle : this.mixin.getTargets()) {
            ...
            final Iterator<String> iterator2 = (Iterator<String>)aliasedElementName.getAliases().iterator();
    ...
    protected static ObfuscationData stripOwnerData(final ObfuscationData obfuscationData) {
        final ObfuscationData obfuscationData2 = new ObfuscationData();
        for (final ObfuscationType obfuscationType : obfuscationData) {
            obfuscationData2.put(obfuscationType, ((IMapping)obfuscationData.get(obfuscationType)).move((String)null));
        }
        return obfuscationData2;
    }
    
    protected static ObfuscationData stripDescriptors(final ObfuscationData obfuscationData) {
        final ObfuscationData obfuscationData2 = new ObfuscationData();
        for (final ObfuscationType obfuscationType : obfuscationData) {
            obfuscationData2.put(obfuscationType, ((IMapping)obfuscationData.get(obfuscationType)).transform((String)null));
        }
        return obfuscationData2;
    }
    ...
    abstract static class AnnotatedElement
    {
        ...
        public AnnotatedElement(final Element element, final AnnotationHandle annotation) {
