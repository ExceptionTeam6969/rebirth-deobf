...
public final class GlowShader extends FramebufferShader
{
    ...
    public void startShader(final Color color, final float n, final float n2, final boolean b, final int n3) {
        GL11.glPushMatrix();
        ...
        this.updateUniforms(color, n, n2, b, n3);
    }
    ...
    public void updateUniforms(final Color color, final float n, final float n2, final boolean b, final int n3) {
    ...
    public void stopDraw(final Color color, final float n, final float n2, final boolean b, final int n3) {
        ...
        this.startShader(color, n, n2, b, n3);
